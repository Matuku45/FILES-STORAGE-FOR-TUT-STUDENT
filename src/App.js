...
function App() {
  ...
  const handleSearch = (e) => {
    e.preventDefault();
    setCurrentView("uploads"); // switch to uploads view to show results
  };
  ...
  // -------- Filter uploaded files based on search --------
      ...
      <div className="bg-dark text-white p-3 sidebar d-flex flex-column">
        ...
        <ul className="nav flex-column flex-grow-1">
          <li className="nav-item mb-2">
            <button
              className={`btn w-100 ${currentView === "dashboard" ? "btn-primary" : "btn-outline-light"}`}
          ...
          <li className="nav-item mb-2">
            <button
              ...
              onClick={() => window.open("https://geminiapi-c01h.onrender.com/", "_blank")}
            >
              Gemini API
            </button>
          </li>
          ...
          <li className="nav-item mt-4">
            <button className="btn btn-outline-light w-100" onClick={() => setCurrentView("login")}>
              Login
            </button>
          </li>
          <li className="nav-item mt-2">
            <button className="btn btn-outline-light w-100" onClick={() => setCurrentView("register")}>
              Register
            </button>
          </li>
        </ul>
